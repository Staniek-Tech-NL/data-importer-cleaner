...
- [v1.0.1 release notes](releases/v1.0.1.md) — current stable audit-hardening release and verification evidence.
- [v1.0.0 release notes](releases/v1.0.0.md) — initial stable package evidence and known limitations.
